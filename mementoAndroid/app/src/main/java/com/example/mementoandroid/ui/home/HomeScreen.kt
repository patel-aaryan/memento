...
//        val sortedPhotos = standalonePhotos.sortedForHome(homeSort)
//
//        // Sort albums
//        val sortedAlbums = albumsWithoutMyPhotos.sortedForHome(homeSort)
//
...
//}
//
//// Extension function for albums
//fun List<AlbumUi>.sortedForHome(sort: HomeSort): List<AlbumUi> {
...
//}
//
//// Extension function for photos
//fun List<AlbumPhotoUi>.sortedForHome(sort: HomeSort): List<AlbumPhotoUi> {
//    return when (sort.kind) {
...
// Extension function for albums - renamed to avoid JVM signature clash
...
// Extension function for photos - renamed to avoid JVM signature clash
